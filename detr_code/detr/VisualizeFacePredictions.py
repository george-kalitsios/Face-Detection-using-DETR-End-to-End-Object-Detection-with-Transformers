...
def infer(images_path, model, postprocessors, device, output_path):
    ...
    for img_sample in images_path:
        ...
        print(bboxes_scaled,len(bboxes_scaled))
        ...
        print('Detection - Visualize encoder-decoder multi-head attention weights')
        if len(bboxes_scaled)>1:
            ...
            for idx, ax_i, (xmin, ymin, xmax, ymax) in zip(keep.nonzero(), axs.T, bboxes_scaled):
                ...
                ax.axis('off')
                # ax.set_title('Detection - Visualize encoder-decoder multi-head attention weights')
